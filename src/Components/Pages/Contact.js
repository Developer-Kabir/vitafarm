      ...
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-xl font-bold">আমাদের ঠিকানা</h4>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-xl font-bold">মোবাইল নাম্বার</h4>
              <p class="text-body-color text-base">(+৮৮)০১৪০৬-৪৭১৬৯২</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-xl font-bold">ইমেইল ঠিকানা</h4>
              <p class="text-body-color text-base">info@vitafarmbd.com</p>
            </div>
          </div>
        </div>
      </div>
