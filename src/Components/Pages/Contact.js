    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          ...
          ভিটাফার্ম একটি প্রাকৃতিক খাবার বিক্রয়কারী প্রতিষ্ঠান । আপনার সুস্বাস্থ্য নিশ্চিত করাই আমাদের লক্ষ্য ।
          </p>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">আমাদের ঠিকানা</h4>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">মোবাইল নাম্বার</h4>
              <p className="text-body-color text-base">(+৮৮)০১৪০৬-৪৭১৬৯২</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">ইমেইল ঠিকানা</h4>
              <p className="text-body-color text-base">info@vitafarmbd.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form>
            ...
            <div className="mb-6">
              <input
                type="email"
                placeholder="ইমেইল ঠিকানা অবশ্যই ইংরেজিতে লিখুন"
                className="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              />
            </div>
            <div className="mb-6">
            ...
            <div className="mb-6">
              <textarea
                rows="6"
                placeholder="আপনার প্রশ্ন অথবা মতামত লিখুন"
