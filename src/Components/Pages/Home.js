...
" alt='' className="max-w-md rounded-2xl shadow-2xl img-fluid" />
                    ...
                    <div>
                        ...
                        <Link to="/honeyNut" className="btn btn-primary">অর্ডার করতে বিস্তারিত পড়ুন</Link>
                    </div>
                </div>
            </div>
            <div className="hero  bg-base-200">
                ...
                <img src="https://i.ibb.co/SRvvfvR/Untitled-design-6.png" alt='' className="max-w-md rounded-2xl shadow-2xl img-fluid" />
                    ...
                    <div>
                        ...
                        <Link to="/greenCoffee" className="btn btn-primary">অর্ডার করতে বিস্তারিত পড়ুন</Link>
                    </div>
                </div>
            </div>
            <div className="hero bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                   ...
                   <img src="https://i.ibb.co/djccWnN/Untitled-design-11.png" alt='' className="max-w-md rounded-2xl shadow-2xl img-fluid" />
                    ...
                    <div>
                        ...
                        <Link to="/chiaSeed" className="btn btn-primary">অর্ডার করতে বিস্তারিত পড়ুন</Link>
                    </div>
                </div>
            </div>
            <div className="hero bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                 ...
                 <img src="https://i.ibb.co/mt5zLvs/Untitled-design-13.png" alt='' className="max-w-md rounded-2xl shadow-2xl img-fluid" /> 
                    ...
                    <div>
                        ...
                        <Link to="/moringa" className="btn btn-primary">অর্ডার করতে বিস্তারিত পড়ুন</Link>
                    </div>
                </div>
            </div>

            <div className="flex flex-col w-full">
                <div className="grid  card bg-base-300 rounded-box place-items-center"><h1 className="text-5xl font-bold py-5 px-12">ভিটাফার্ম থেকে কেন কিনবেন ?</h1></div>
